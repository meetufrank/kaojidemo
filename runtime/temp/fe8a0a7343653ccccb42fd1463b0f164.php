<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:47:"D:\www\cltphp/app/admin\view\category\edit.html";i:1513746012;s:45:"D:\www\cltphp/app/admin\view\common\head.html";i:1512630547;s:45:"D:\www\cltphp/app/admin\view\common\foot.html";i:1503623995;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="admin-main fadeInUp animated">
    ...
    <form class="layui-form layui-form-pane">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">前台列表页模板</label>
            <div class="layui-input-3">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">前台内容页模板</label>
            <div class="layui-input-3">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">后台列表页模板</label>
            <div class="layui-input-3">
                <select name="atemplate_list" id="atemplate_list">
                </select>
            </div>
        </div>
        <div class="layui-form-item">
...
<script>
    ...
    <?php endforeach; endif; else: echo "" ;endif; ?>
    var atemplatearr = new Array();
    <?php if(is_array($atemplates) || $atemplates instanceof \think\Collection || $atemplates instanceof \think\Paginator): $i = 0; $__LIST__ = $atemplates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tem): $mod = ($i % 2 );++$i;?>
    atemplatearr[<?php echo $i; ?>] = "<?php echo $tem['value']; ?>,<?php echo $tem['filename']; ?>";
    <?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    function showtemplist(m,t,form){
        ...
        for(i=1;i<atemplatearr.length;i++){
            data = atemplatearr[i].split(',');
            if(data[0].indexOf(mtlist)  >= 0){
                listdatas  ="<option value='"+data[0]+"'>"+data[1]+"</option>";
                $('#atemplate_list').append(listdatas);
            }
            
        }
        $("#template_list").val('<?php echo $record['template_list']; ?>');
        $("#template_show").val('<?php echo $record['template_show']; ?>');
        $("#atemplate_list").val('<?php echo $record['atemplate_list']; ?>');
        if(form){
            form.render()
        }
    }
