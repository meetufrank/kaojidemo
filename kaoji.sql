...
INSERT INTO `clt_admin` VALUES ('8', 'wangjin', 'e10adc3949ba59abbe56e057f20f883e', '2', '8234738438@qq.com', '0', '18767654897', '127.0.0.1', '1498815814', '0', '1');
...
INSERT INTO `clt_auth_rule` VALUES ('27', 'Users', '会员管理', '1', '1', '0', 'icon-user', '', '0', '6', '1447231507', '1', '1');
...
INSERT INTO `clt_auth_rule` VALUES ('280', 'Wechat/delText', '操作-删除', '1', '1', '0', '', '', '277', '50', '1513849401', null, '1');
INSERT INTO `clt_auth_rule` VALUES ('278', 'Wechat/addText', '操作-添加', '1', '1', '0', '', '', '277', '50', '1513849357', null, '1');
...
-- ----------------------------
-- Table structure for clt_paylist
-- ----------------------------
DROP TABLE IF EXISTS `clt_paylist`;
CREATE TABLE `clt_paylist` (
  `id` tinyint(4) NOT NULL AUTO_INCREMENT COMMENT '//编号',
  `payname` varchar(100) NOT NULL COMMENT '支付渠道名称',
...
-- ----------------------------
-- Table structure for clt_type
-- ----------------------------
DROP TABLE IF EXISTS `clt_type`;
CREATE TABLE `clt_type` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(80) NOT NULL DEFAULT '',
  `title_style` varchar(225) NOT NULL DEFAULT '',
  `thumb` varchar(225) NOT NULL DEFAULT '',
  ...
  `template` varchar(40) NOT NULL DEFAULT '',
  `catid` smallint(5) unsigned NOT NULL DEFAULT '0',
  `kj_options` varchar(255) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
...
-- Records of clt_type
-- ----------------------------
INSERT INTO `clt_type` VALUES ('1', '大号喇叭', 'color:rgb(255, 87, 34);font-weight:bold;', '/uploads/20171205/7bca3aff25741170f7ab20c3fc881f2d.jpg', '0', '1', '1', 'admin', '0', '1512448907', '1512711828', '0', '0', '12', '1,3');
INSERT INTO `clt_type` VALUES ('2', '喇叭', 'color:rgb(255, 153, 0);font-weight:bold;', '/uploads/20171205/5bc43ece37d294669bf4c64b7373381c.jpg', '0', '1', '1', 'admin', '1', '1512448944', '1512711835', '0', '0', '12', '1,2,3');
...
-- ----------------------------
DROP TABLE IF EXISTS `clt_user_kaod`;
CREATE TABLE `clt_user_kaod` (
  `kd_id` tinyint(4) NOT NULL AUTO_INCREMENT,
  `kd_name` varchar(200) NOT NULL,
  `sort` int(8) NOT NULL DEFAULT '0',
  `area` int(8) NOT NULL DEFAULT '1' COMMENT '//地区',
  PRIMARY KEY (`kd_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_user_kaod
-- ----------------------------
INSERT INTO `clt_user_kaod` VALUES ('2', '考点1', '50', '2');
...
-- ----------------------------
INSERT INTO `clt_wx_default_replay` VALUES ('2', '0', '4', '0', '1512528613', '1513849629');
